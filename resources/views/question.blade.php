    ...
    <div class="center">
        ...
        <div class="content">
            ...
            <form action="question" method="post">
                <input type="text" name="userName" placeholder="Введите Ваше имя" style="margin: 5px" required><br>
                <input type="email" name="userEmail" placeholder="Введите Вашу почту" style="margin: 5px" required><br>
                ...
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="submit" name="questionButton" value="Отправить" style="margin: 5px">
            </form>
        </div>
    </div>
@endsection